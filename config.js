...
module.exports = {
	...
	ALIVE: process.env.ALIVE || "Y69L i'm alive",
	ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE || "true"),
	BGMBOT : toBool(process.env.BGMBOT || "false"),
	API: "https://api-aswin-sparky.koyeb.app",
	AUDIO_DATA: process.env.AUDIO_DATA || "ᴡhois.Sтᴀʀʙᴏʏ<3,₉₀ᷤ₆ͭ₁ͣ₈ᷢ₀₁ⷡ₄ͦ₀ⷱ₈乡,https://telegra.ph/file/c1796557a792cd6f400e7.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "Y69 Լ ㌥;Y69L;https://i.ibb.co/ZQvKxrQ/temp.jpg",
	...
	STICKER_DATA: process.env.STICKER_DATA || `STARBOY;Y69 Լ ㌥`,
	SUDO: process.env.SUDO || "375291553397",
